                ...
                success: (msg) => {
                    ...
                    if (!msg.error) {
                        ...
                        if (aweme_type === 4) {
                            ...
                            window.open(`download?video_url_web=${video_url}&video_name=${video_name}`, "_self");
                        }
                        //图集
...
console.log(`
GitHub: https://github.com/UlovHer

Website: https://github.com/UlovHer

Email: ulovher@gmail.com
